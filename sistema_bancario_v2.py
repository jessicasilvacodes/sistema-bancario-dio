'''
Otimizar o sistema bancário aplicar novas implementações na segunda versão do sistema (v2):

- criar um decorador de log e estabelecer um limite de 10 transações diárias para a conta, aplicado para todas as funções de transações, seja depósito, ou saque, ou criação de conta, etc.;
